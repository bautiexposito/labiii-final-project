...
public class ClienteServiceTest {
    ...
    public void testClienteAlreadyExistsException() throws ClienteAlreadyExistsException {
        ...
        when(clienteDao.findCliente(26456437, false)).thenReturn(new Cliente());
    ...
    public void testAgregarCuentaAClienteSuccess() throws TipoCuentaAlreadyExistsException {
        ...
        when(clienteDao.findCliente(26456439, true)).thenReturn(pepeRino);

        clienteService.agregarCuenta(cuenta, pepeRino.getDni());

        verify(clienteDao, times(1)).saveCliente(pepeRino);
    ...
    public void testAgregarCuentaAClienteDuplicada() throws TipoCuentaAlreadyExistsException {
        ...
        when(clienteDao.findCliente(26456439, true)).thenReturn(luciano);
        ...
        verify(clienteDao, times(1)).saveCliente(luciano);
    ...
    public void testAgregarCAyCC() throws CuentaAlreadyExistsException, TipoCuentaAlreadyExistsException {
        ...
        when(clienteDao.findCliente(43046272, true)).thenReturn(cliente);
        ...
        // Verifica
        verify(clienteDao, times(2)).saveCliente(cliente);
    ...
    public void testBuscarPorDni_Falla() {
        when(clienteDao.findCliente(43046272, true)).thenReturn(null);
